...
program
  .command("list")
  .description("list/select resources; interactive TUI installs your selection")
...
program
  ...
  .description(
    "install a resource into ./.claude (supports type:name@version); no arg opens the TUI"
  )
  .action(addCommand);
